...
<h1>About the PHP, JavaScript, HTML, &amp; CSS</h1>
 <ul class=\"FinePrint\">
  ...
  the resource, SeSDoCForm.php, as specified in the form's action property.  
  ...
  head of the document. Find the function ValidateForm() in the file SeSDoCValidateForm.js 
  ...
  <li>The server-side script is available at /home/SeSDoC/web/SeSDoCForm.php.  </li>
  ...
  <li>From the command line find the function  MakeTheForm() at the beginning or SeSDoCForm.php. 
  ...
  The properties of OtherStates, SEStatesVisited, and SEStateFavorite 
        are loaded by reading text files off the web direcgtory at /home/tinstructor/OptionsOtherStates and OptionsSEStates. 
        ...
        tedious hand-editing for each control.  <br /><br />
         ...
         Note that the checkboxes for SEStatesVisited and radio buttons for SEStateFavorite are built in the same loop.
         <br /><br />
  ...
  used to receive post data in the PHP script.  In the HTML, note that SEStatesVisisted[] and OtherStates[]
  ...
  <li>The Form's onSubmit event calls the JavaScript function ValidateForm().
         ...
         to the script specified in the form's method, in this case SeSDoCForm.php.</li>
