...
function MakeTheForm($ValidationErrors) {
  ...
  $TheForm .= "      <p><label for=\"Lastname\">$SplatSlug Last Name:</label>
          <input type=\"text\" name=\"Lastname\" id=\"Lastname\" value=\"$Firstname\" placeholder=\"Lastname\" autofocus />
            </p><br /> \n";
...
$FavStateRB
 ...
 ";
  if ($MALeastFavoriteWeather == 'Timothy') { $SelectedSlug = "selected"; } else { $SelectedSlug = ''; }
  $TheForm .= "            <option value=\"Timothy\" $SelectedSlug>Timothy</option>\n";
  if ($MALeastFavoriteWeather == 'Orchard') { $SelectedSlug = "selected"; } else { $SelectedSlug = ''; }
  ...
  if ($MALeastFavoriteWeather == 'Oat') { $SelectedSlug = "selected"; } else { $SelectedSlug = ''; }
...
if ($View == 'First') {
  ...
  if (!isset($Address) or $Address== '') $ValidationErrors['Address'] = "Name is missing or empty.  Please enter your last name before clicking Submit.";
  if (!isset($LastName) or $LastName== '') $ValidationErrors['LastName'] = "Last Nameis missing or empty.  Please enter your address before clicking Submit.";
  ...
  if (!isset($MALeastFavoriteWeather) or $MALeastFavoriteWeather == '') {
    ...
    $ValidationErrors['MALeastFavoriteWeather'] = "Please select your favorite hay!";
  }
