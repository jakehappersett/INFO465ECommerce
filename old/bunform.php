...
function MakeTheForm($ValidationErrors) {
  if (isset($_POST['Firstname'])) {
    ...
    $Lastname = '';
    $
    $MAEmail = ''; $MASMS = ''; $MASEStatesVisited = '';
    $MASEStateFavorite = '';
    $MAOpinion = '';
    $MAColor = '';
    $MAPass1 = '';
  ...
  $TheForm .= "<p><label for=\"Firstname\">$SplatSlug Name:</label>
  ...
  $TheForm .= "      <p><label for=\"Lastname\">$SplatSlug Name:</label>
  ...
  $StatesSEFile = fopen('/home/tinstructor/OptionsStatesSE','r');
  $FavStateRB = '';
...
$FavStateRB
 ...
 ";
  ...
  $StatesNotSEFile = fopen('/home/tinstructor/OptionsStatesNotSE','r');
...
if ($View == 'First') {
  ...
  if (!isset($Firstname) or $Firstname== '') $ValidationErrors['Firstname'] = "Name is missing or empty.  Please enter your name before clicking Submit.";
